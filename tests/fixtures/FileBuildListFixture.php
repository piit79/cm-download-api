...
namespace Tests\Fixtures {
    ...
    class FileBuildListFixture extends \PHPUnit_Framework_Assert implements BuildListInterface
    {
        ...
        {
            $extension = array_search($type, File::$FILE_TYPES);
            if ($extension === false) {
        ...
        {
            $fileName = $this->getFileName(File::JSON);
        ...
        {
            $fileName = $this->getFileName(File::YAML);
            $data = $this->getBuildData();
        ...
        {
            $fileName = $this->getFileName(File::CSV);
            $data = $this->getBuildData();
            $fp = fopen($fileName, 'w');
        ...
        {
            $fileName = $this->getFileName(File::XML);
