...
namespace Cm\Download\Api\BuildList {
    ...
    /**
     * FolderBuildList class allows loading of build data from a directory structure containing the actual builds
     *
     ...
     */
    class FolderBuildList extends AbstractBuildList
    {
        ...
        /**
         * Return the Android API level of a build
         *
         * @param string $buildPath
